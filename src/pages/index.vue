<template>
  <div>
    ...
    >
      <vue-stack>
        <vue-text look="h2" as="h2">Developer Experience</vue-text>

        <vue-stack space="8">
          <vue-text look="h3" as="h3">Quick scaffolding</vue-text>
          <p>Create components, VueX connected components, modules - and their tests - right from the CLI!</p>
        </vue-stack>

        <vue-stack space="8">
          <vue-text look="h3" as="h3">Instant feedback</vue-text>
          <p>
            Enjoy the best DX (Developer eXperience) and code your app at the speed of thought! Your saved changes to
            the CSS and TypeScript are reflected instantaneously without refreshing the page or restarting your server.
            Preserve application state even when you update something in the underlying code!
          </p>
        </vue-stack>

        <vue-stack space="8">
          <vue-text look="h3" as="h3">Tons of use-cases</vue-text>
          <p>
    ...
    >
      <vue-stack>
        <vue-text look="h2" as="h2">Enterprise ready</vue-text>

        <vue-stack space="8">
          <vue-text look="h3" as="h3">SEO</vue-text>
          <p>
        ...
        <vue-stack space="8">
          <vue-text look="h3" as="h3">Best practices</vue-text>
          <p>
        ...
        <vue-stack space="8">
          <vue-text look="h3" as="h3">i18n</vue-text>
          <p>
    ...
    >
      <vue-stack>
        <vue-text look="h2" as="h2">User experience</vue-text>

        <vue-stack space="8">
          <vue-text look="h3" as="h3">Animations</vue-text>
          <p>
        ...
        <vue-stack space="8">
          <vue-text look="h3" as="h3">Progressive-Web-App</vue-text>
          <p>Offline-first support with service-workers and a lighthouse score as high as possible (90+).</p>
        </vue-stack>

        <vue-stack space="8">
          <vue-text look="h3" as="h3">Design System</vue-text>
          <p>
    ...
    >
      <vue-stack>
        <vue-text look="h2" as="h2">Quick start</vue-text>

        <vue-stack space="16">
          <vue-text look="h3" as="h3"> Via <code>npx</code> </vue-text>
          <ol>
            <li>
        ...
        <vue-stack space="16">
          <vue-text look="h3" as="h3">Via Git</vue-text>
          <ol>
            <li>
