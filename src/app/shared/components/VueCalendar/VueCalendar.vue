    ...
    computed:   {
      ...
      weekdays(): string[] {
        const weekdays: string[] = [
          this.$t('app.components.calendar.sunday.short' /*S*/),
          this.$t('app.components.calendar.monday.short' /*M*/),
          this.$t('app.components.calendar.tuesday.short' /*T*/),
          this.$t('app.components.calendar.wednesday.short' /*W*/),
          this.$t('app.components.calendar.thursday.short' /*T*/),
          this.$t('app.components.calendar.friday.short' /*F*/),
          this.$t('app.components.calendar.saturday.short' /*S*/),
        ];
